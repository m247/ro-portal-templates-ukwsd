...
$pdf->SetFont('helvetica','',9);
$pdf->Cell(140,4,"HSBC Bank Plc",'R',1,'L',1);
$pdf->SetFont('helvetica','B',9);
$pdf->Cell(40,4,"Address:",'L',0,'L',1);
$pdf->SetFont('helvetica','',9);
$pdf->Cell(140,4,"136 High St",'R',1,'L',1);
$pdf->SetFont('helvetica','B',9);
$pdf->Cell(40,4,"",'L',0,'L',1);
$pdf->SetFont('helvetica','',9);
$pdf->Cell(140,4,"Stockton-On-Tees",'R',1,'L',1);
$pdf->SetFont('helvetica','B',9);
$pdf->Cell(40,4,"",'L',0,'L',1);
$pdf->SetFont('helvetica','',9);
$pdf->Cell(140,4,"TS18 1LR",'R',1,'L',1);
$pdf->SetFont('helvetica','B',9);
...
$pdf->SetFont('helvetica','',9);
$pdf->Cell(140,4,"40-43-11",'R',1,'L',1);
$pdf->SetFont('helvetica','B',9);
$pdf->Cell(40,4,"Account Number:",'L',0,'L',1);
$pdf->SetFont('helvetica','',9);
$pdf->Cell(140,4,"61716948",'R',1,'L',1);
$pdf->SetFont('helvetica','B',9);
$pdf->Cell(40,4,"SWIFT:",'L',0,'L',1);
$pdf->SetFont('helvetica','',9);
$pdf->Cell(140,4,"MIDLGB2157C",'R',1,'L',1);
$pdf->SetFont('helvetica','B',9);
$pdf->Cell(40,4,"IBAN:",'L','R','L',1);
$pdf->SetFont('helvetica','',9);
$pdf->Cell(140,4,"GB58 MIDL 404311 61716948",'R',1,'L',1);
$pdf->Cell(0,2,"",'LR',1,'L',1);
